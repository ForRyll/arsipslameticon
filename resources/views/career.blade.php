...
<body class="bg-[#ffffff] text-black antialiased selection:bg-[#1112A2] selection:text-white">
    ...
    <!-- ==========================================
         ...
         ========================================== -->
    <section
        class="py-16 md:py-24 px-6 md:px-12 max-w-[1450px] mx-auto min-h-[calc(100vh-100px)] flex flex-col justify-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div class="max-w-lg mx-auto lg:mx-0">
                ...
                <p class="text-gray-500 text-[14px] md:text-[15px] leading-relaxed">
                    We're curious, creative, and diverse, driven by the purpose of our work and energized by the joy we
                    get from supporting each other. We build awesome stuff that helps people and love doing it together.
                </p>
            </div>

            <!-- KOLOM KANAN: FOTO CAREER -->
            <div class="flex justify-center lg:justify-end">
                <div class="w-full max-w-[520px] overflow-hidden rounded-xl">
                    <img src="{{ asset('images/career.png') }}" alt="Career Slameticon Digital Valley"
        ...
        <div class="max-w-[1000px] mx-auto">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="border border-gray-300 rounded-lg bg-white overflow-hidden transition-colors duration-300">
                    ...
                    <button onclick="toggleJob('job1')"
                        class="w-full flex items-center justify-between p-5 md:p-6 text-left group hover:bg-gray-100 transition-colors duration-300">
                        <span class="text-[17px] md:text-lg font-semibold text-[#1218ae]">Graphic Designer</span>
                        <div class="flex items-center gap-4">
                            <span class="text-[13px] md:text-sm text-gray-500 hidden md:block">Full-Time, Remote -
                                Technical Writer & Documentation</span>
                            <!-- Icon Panah (Berputar saat di-hover grupnya) -->
                            <svg class="w-5 h-5 text-gray-400 transform transition-transform duration-300 group-hover:rotate-90"
                    ...
                    <div id="job1" class="max-h-0 overflow-hidden transition-all duration-500 ease-in-out"
                        ...
                        <div class="p-6 border-t border-gray-200 bg-gray-50">
                            ...
                            <p class="text-[14px] text-gray-600 mb-5 leading-relaxed">
                                We are looking for a creative Graphic Designer with up-to-date knowledge to interpret
                                our clients needs and to design solutions with high visual impact. You will work on a
                                variety of products, including websites, books, magazines, product packaging, and
                                corporate identity.
                            </p>
                            ...
                            <!-- Tombol Apply -->
                            <a href="{{ url('/apply') }}?job=Graphic+Designer"
                                class="inline-flex items-center justify-center bg-[#1218ae] text-white px-6 py-2.5 rounded text-[14px] font-medium hover:bg-[#1112A2] transition-colors">
                                Apply now &rarr;
                            </a>
                        </div>
                    </div>
                ...
                <div class="border border-gray-300 rounded-lg bg-white overflow-hidden transition-colors duration-300">
                    ...
                    <div id="job2" class="max-h-0 overflow-hidden transition-all duration-500 ease-in-out"
                        style="max-height: 0px;">
                        <div class="p-6 border-t border-gray-200 bg-gray-50">
                            <h4 class="font-semibold text-gray-900 mb-2 text-sm">Job Description</h4>
                            <p class="text-[14px] text-gray-600 mb-5 leading-relaxed">
                                Join our team to transform raw data into meaningful insights. You will be responsible
                                for managing our master data set, developing reports, and troubleshooting data issues to
                            ...
                            <a href="{{ url('/apply') }}?job=Senior+Data+Analyst"
                                class="inline-flex items-center justify-center bg-[#1218ae] text-white px-6 py-2.5 rounded text-[14px] font-medium hover:bg-[#1112A2] transition-colors">
                                Apply now &rarr;
                            </a>
                        </div>
                ...
                <div class="border border-gray-300 rounded-lg bg-white overflow-hidden transition-colors duration-300">
                    ...
                    <div id="job3" class="max-h-0 overflow-hidden transition-all duration-500 ease-in-out"
                        style="max-height: 0px;">
                        <div class="p-6 border-t border-gray-200 bg-gray-50">
                            <h4 class="font-semibold text-gray-900 mb-2 text-sm">Job Description</h4>
                            <p class="text-[14px] text-gray-600 mb-5 leading-relaxed">
                                We are looking for an experienced Product Manager who is passionate about building
                                products that customers love. You will join a dynamic and fast-paced environment and
                                work with cross-functional teams to design, build, and roll out products.
                            </p>
                            <h4 class="font-semibold text-gray-900 mb-2 text-sm">Key Responsibilities</h4>
                            <ul class="list-disc list-outside ml-4 text-[14px] text-gray-600 mb-6 space-y-1.5">
                            ...
                            <a href="{{ url('/apply') }}?job=Product+Manager"
                                class="inline-flex items-center justify-center bg-[#1218ae] text-white px-6 py-2.5 rounded text-[14px] font-medium hover:bg-[#1112A2] transition-colors">
                                Apply now &rarr;
                            </a>
                        </div>
                ...
                <div class="border border-gray-300 rounded-lg bg-white overflow-hidden transition-colors duration-300">
                    <button onclick="toggleJob('job4')"
                        class="w-full flex items-center justify-between p-5 md:p-6 text-left group hover:bg-gray-100 transition-colors duration-300">
                        <span class="text-[17px] md:text-lg font-semibold text-[#1218ae]">AI Logistics Solution
                            Architect</span>
                        <div class="flex items-center gap-4">
                            <span class="text-[13px] md:text-sm text-gray-500 hidden md:block">Full-Time, Remote -
                                Technical Writer & Documentation</span>
                    ...
                    <div id="job4" class="max-h-0 overflow-hidden transition-all duration-500 ease-in-out"
                        style="max-height: 0px;">
                        <div class="p-6 border-t border-gray-200 bg-gray-50">
                            <h4 class="font-semibold text-gray-900 mb-2 text-sm">Job Description</h4>
                            <p class="text-[14px] text-gray-600 mb-5 leading-relaxed">
                                Lead the design and implementation of AI-driven logistics solutions. You will work
                                closely with stakeholders to understand their supply chain challenges and develop
                                advanced machine learning models to optimize routes, manage inventory, and predict
                                demand.
                            </p>
                            <h4 class="font-semibold text-gray-900 mb-2 text-sm">Key Responsibilities</h4>
                            <ul class="list-disc list-outside ml-4 text-[14px] text-gray-600 mb-6 space-y-1.5">
